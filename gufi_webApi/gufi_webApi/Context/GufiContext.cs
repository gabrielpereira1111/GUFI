...
namespace gufi_webApi.Context
{
    public partial class GufiContext : DbContext
    {
        ...
        public virtual DbSet<ImagemUsuario> ImagemUsuarios { get; set; } = null!;
        public virtual DbSet<Instituicao> Instituicaos { get; set; } = null!;
        public virtual DbSet<Presenca> Presencas { get; set; } = null!;
        public virtual DbSet<Situacao> Situacaos { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=DSK_PHD001\\SQLEXPRESS;Initial Catalog=Gufi;user Id=sa;pwd=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Evento>(entity =>
            {
                entity.HasKey(e => e.IdEvento)
                    .HasName("PK__evento__C8DC7BDAF72348B1");
                ...
                entity.HasOne(d => d.IdInstituicaoNavigation)
                    ...
                    .HasConstraintName("FK__evento__idInstit__31EC6D26");

                entity.HasOne(d => d.IdTipoEventoNavigation)
                    .WithMany(p => p.Eventos)
                    .HasForeignKey(d => d.IdTipoEvento)
                    .HasConstraintName("FK__evento__idTipoEv__30F848ED");
            });

            modelBuilder.Entity<ImagemUsuario>(entity =>
            {
                entity.HasKey(e => e.IdImagemUsuario)
                    .HasName("PK__ImagemUs__078BE970F0DE5E1C");
                ...
                entity.HasOne(d => d.IdUsuarioNavigation)
                    ...
                    .HasConstraintName("FK__ImagemUsu__idUsu__49C3F6B7");
            });

            modelBuilder.Entity<Instituicao>(entity =>
            {
                entity.HasKey(e => e.IdInstituicao)
                    .HasName("PK__institui__8EA7AB0073DA88AA");

                entity.ToTable("instituicao");

                entity.HasIndex(e => e.Cnpj, "UQ__institui__35BD3E489D55E006")
                    .IsUnique();

                entity.HasIndex(e => e.Endereco, "UQ__institui__9456D40671C73280")
                    .IsUnique();
            ...
            modelBuilder.Entity<Presenca>(entity =>
            {
                entity.HasKey(e => e.IdPresenca)
                    .HasName("PK__presenca__44CEA427CFAFC814");
                ...
                entity.HasOne(d => d.IdSituacaoNavigation)
                    ...
                    .HasConstraintName("FK__presenca__idSitu__398D8EEE");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Presencas)
                    .HasForeignKey(d => d.IdUsuario)
                    .HasConstraintName("FK__presenca__idUsua__37A5467C");
            });

            modelBuilder.Entity<Situacao>(entity =>
            {
                entity.HasKey(e => e.IdSituacao)
                    .HasName("PK__situacao__12AFD197C4C00F96");
            ...
            modelBuilder.Entity<TipoEvento>(entity =>
            {
                entity.HasKey(e => e.IdTipoEvento)
                    .HasName("PK__tipoEven__09EED93A029CC3EF");
            ...
            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                entity.HasKey(e => e.IdTipoUsuario)
                    .HasName("PK__tipoUsua__03006BFF21E9DB12");

                entity.ToTable("tipoUsuario");

                entity.HasIndex(e => e.TituloTipoUsuario, "UQ__tipoUsua__C6B29FC3E8003B5B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__usuario__645723A6EA50B2C4");

                entity.ToTable("usuario");

                entity.HasIndex(e => e.Email, "UQ__usuario__AB6E6164EC81E52F")
                    .IsUnique();
